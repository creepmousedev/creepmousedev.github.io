...
function playCpuArray(){
    ...
    $.each(cpuArray, function(index, value){
        setTimeout(() => {
            switch(value){
                case 0:
                    cpuDisplayEffects("#greenButton", "newGreenButtonhighlight.png", "green.mp3");
                    break;
                case 1:
                    cpuDisplayEffects("#blueButton", "newBlueButtonHighlight.png", "blue.mp3");
                    break;
                case 2:
                    cpuDisplayEffects("#yellowButton", "newYellowButtonHighlight.png", "yellow.mp3");
                    break;
                case 3:
                    cpuDisplayEffects("#redButton", "newRedButtonHighlight.png", "red.mp3");
                    break;
                default:
...
//MAY DELETE CAUSE IT MIGHT NOT BE NEEDED
function makeCapital(word){
    return word = word.slice(0,1).toUpperCase() + word.slice(1,word.length).toLowerCase();
}

function resetGame(){
    var lost = new Audio("wrong.mp3");
    degrees = 0;
    clicks = 0;
    currentLevel = 1;
    cpuArray = [];
...
function setupAllButtons(){
    setupButton("#greenButton", "newGreenButton.png", "newGreenButtonhighlight.png", "green.mp3");
    setupButton("#blueButton", "newBlueButton.png", "newBlueButtonHighlight.png", "blue.mp3");
    setupButton("#yellowButton", "newYellowButton.png", "newYellowButtonHighlight.png", "yellow.mp3");
    setupButton("#redButton", "newRedButton.png", "newRedButtonHighlight.png", "red.mp3");
}
